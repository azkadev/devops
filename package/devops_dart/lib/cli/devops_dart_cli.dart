...
import 'package:devops/api/devops_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  DevopsDartApi packageFullTemplateDartApi = DevopsDartApi();
  ...
  DevopsDartBuildType server_universeDartBuildType = DevopsDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = DevopsDartBuildType.debug;
  }
